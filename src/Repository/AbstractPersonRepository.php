 ...
 */
class AbstractPersonRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return AbstractPerson[] Returns an array of AbstractPerson objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?AbstractPerson
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.exampleField = :val')
            ->setParameter('val', $value)
