 ...
 */
final class Version20210118064212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE imdis_abstract (id INT AUTO_INCREMENT NOT NULL, theme_id INT NOT NULL, title VARCHAR(255) NOT NULL, abstract LONGTEXT NOT NULL, imdis_id VARCHAR(255) NOT NULL, INDEX IDX_1AA07CB059027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE person (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, affiliation VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, orcid VARCHAR(255) DEFAULT NULL, show_in_list TINYINT(1) DEFAULT \'0\' NOT NULL, show_mail_in_list TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE poster (id INT AUTO_INCREMENT NOT NULL, abstract_id INT NOT NULL, poster_session_id INT NOT NULL, video_url VARCHAR(255) DEFAULT NULL, comment_url VARCHAR(255) DEFAULT NULL, download_url VARCHAR(255) DEFAULT NULL, session_url VARCHAR(255) DEFAULT NULL, INDEX IDX_2D710CF2D56B77AA (abstract_id), INDEX IDX_2D710CF24C4C8295 (poster_session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE poster_session (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE presentation_person (id INT AUTO_INCREMENT NOT NULL, presentation_id INT NOT NULL, person_id INT NOT NULL, sort INT NOT NULL, presentater TINYINT(1) NOT NULL, INDEX IDX_95EB27F3AB627E8B (presentation_id), INDEX IDX_95EB27F3217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE presentation_type (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, fields_required LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', fields_no_allowed LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE program_session (id INT AUTO_INCREMENT NOT NULL, block_id INT NOT NULL, theme_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_5BAE2D00E9ED820C (block_id), INDEX IDX_5BAE2D0059027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
