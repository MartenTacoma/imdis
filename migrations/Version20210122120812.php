 ...
 */
final class Version20210122120812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_2D710CF2D56B77AA ON poster');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2D710CF2D56B77AA ON poster (abstract_id)');
    }
}
